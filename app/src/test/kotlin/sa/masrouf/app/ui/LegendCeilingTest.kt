...
/**
 * The month card's legend has one row per category the month touched, and there are
 * nineteen categories. Unbounded, a varied month pushed the history the card sits
 * above off the screen entirely.
 *
 * Deleted with the ceiling in September 2026 and restored with it. The ceiling was
 * removed because the months it fired on carried eight or nine categories; measured
 * a year later, August and July 2026 carry sixteen. The tests never stopped being
 * right - the month stopped being small.
 */
